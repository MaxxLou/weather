...
export default function Forecast({ data }: ForecastProps): JSX.Element {
  const today = data.list[0]
  return (
    <>
      <div className="w-full md:max-w-[500px] p-4 md:py-4 md:px-10 lg:px-24 lg:h-auto bg-white bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg">
        <div className="mx-auto w-[300px]">
          <section className="text-center text-zinc-700">
            <h2 className="text-2xl font-bold">
              {data.name}
              <span className="font-thin"> {data.country}</span>
            </h2>
            <h1 className="text-4lx font-extrabold">
